...
export const runStoreRuns = sqliteTable('run_store_runs', {
  ...
  scenarioProgressJson: text('scenario_progress_json').notNull().default('null'),
...
export const testRequestQueue = sqliteTable('test_request_queue', {
  ...
  preparedMergeCommit: text('prepared_merge_commit'),
  preparedMergeMode: text('prepared_merge_mode'),
  resolvedTargetCommit: text('resolved_target_commit'),
